...
## Todo
- Added new example values of the tables and recall the data collection method and frequency for the indicator "% increase in tourism activities, festival participation and revenue from festivals (Trade Fairs)"
- Design the ERD layout for the indicator "% increase in tourism activities, festival participation and revenue from festivals (Trade Fairs)"




- Design the data model for the "Adoption percentage of electric vehicles in public transport" and "Increase percentage in TNVS (Transport Network Vehicle Service) slots for public transport"

...
## Todo
- After implementing all the data model for the lead department of "PEO" check which facts table reference to the same dimension "facilities" and analyze if it can be stored in one table to remove redundancy but also promotes easier read operation

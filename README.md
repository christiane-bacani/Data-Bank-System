...
## Todo
- Create a dedicated data model to track both the indicator `% increase in innovation hubs established` and `Increase percentage in renewable energy projects and green mobility adoption` and use AI to check if this is feasible and possible for government settings.

...
## Todo
- Recall the data collection method and frequency for the indicator "% increase in tourism activities, festival participation and revenue from festivals (Trade Fairs)"

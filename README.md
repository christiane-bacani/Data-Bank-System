...
## Todo
- Check the given granularity for the right data capture for measuring the indicator "increase percentage in SMEs using online systems for business permits"

...
## Todo
- Create new attributes to the table "fact_economic_growth_reports"
- Check on how to integrate the data model with an indicator of "Increase percentage in disaster-resilient infrastructure" to the data model with an indicator of "Improvement percentage in infrastructure and market access"
